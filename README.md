...
一款面向 Android 的离线轨迹记录应用，可以在后台记录 GPS 路线，并将路线导出为 GPX 或 GeoJSON 文件。这里的 GPS 面向普通用户表述，泛指手机卫星定位能力，包括北斗/GNSS 等系统。
...
- 作者：蓝芷怡。
- 本项目由蓝芷怡维护，部分代码、文档与工程整理由 AI 辅助编写。
- 本项目基于 MIT 开源项目改造，感谢原作者 Brad Patras 和原项目贡献者。原项目地址：[BradPatras/gpx-recorder](https://github.com/BradPatras/gpx-recorder)。
